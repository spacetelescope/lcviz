    ...
    def bin(self, add_data=True):
        ...
        if add_data:
            ...
            if self.ephemeris_selected != 'No ephemeris':
                ...
                ephemeris_plugin = self._app._jdaviz_helper.plugins['Ephemeris']
                phase_comp = self._app._jdaviz_helper._component_ids[phase_comp_lbl(self.ephemeris_selected)]  # noqa
