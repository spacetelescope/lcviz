...
.. wireframe-demo:: _static/jdaviz-wireframe.html
   ...
   :repeat: false
   :steps-json: [{"action": "show-sidebar", "value": "plugins", "delay": 1500, "caption": "Open the plugin toolbar"}, {"action": "open-panel", "value": "Flux Column", "delay": 1000, "caption": "Open the Flux Column plugin"}]
