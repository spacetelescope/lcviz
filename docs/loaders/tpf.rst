...
.. wireframe-demo:: _static/jdaviz-wireframe.html
   ...
   :repeat: false
   :steps-json: [{"action": "show-sidebar", "value": "loaders", "delay": 1500, "caption": "Open the data loader"}, {"action": "select-dropdown", "value": "Format:TPF", "delay": 1000, "caption": "Set format to TPF"}, {"action": "highlight", "target": "#format-select", "delay": 1500}]
